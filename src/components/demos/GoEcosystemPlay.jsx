...
import {
  ...
  defaultEnabledNodes,
  bundleSummary,
} from '@/components/shared/kb/goEcosystemEngine';
import styles from '@/components/demos/GoEcosystemPlay.module.css';
...
function GoEcosystemPlayInner() {
  ...
  const [archId, setArchId] = useState('gin-clean');
  ...
  return (
    <DemoShell className={styles.root}>
      <DemoCard
        ...
        subtitle="Слои стека, граф модулей, структура сервиса, сборка и организация пакетов"
      >
        ...
        {tab === 'deps' && (
          <>
            ...
            <p className={styles.hint}>
              ...
              Клик по узлу переключает участие в сборке. Отключите <code>internal/worker</code> — исчезнут рёбра к NATS и
              часть связей с service.
            </p>
...
export default GoEcosystemPlayInner;
