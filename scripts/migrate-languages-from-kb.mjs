/**
 * Копирует React-демо из docs/encyclopedia/5-languages (it-knowledge-base) в it-play.
 * Usage: node scripts/migrate-languages-from-kb.mjs [--dry-run]
 */
...
const KB_DOCS = path.join(KB_ROOT, 'docs', 'encyclopedia', '5-languages');
...
const TITLE_MAP = {
  AdoDataAccessPlay: 'ADO.NET — доступ к данным',
  AspNetArchitecturePlay: 'Архитектура ASP.NET',
  AssemblerEcosystemPlay: 'Экосистема Assembler',
  BashEcosystemPlay: 'Экосистема Bash',
  CEcosystemPlay: 'Экосистема C',
  CobolEcosystemPlay: 'Экосистема COBOL',
  CppDatabasePlay: 'C++ и базы данных',
  CppEcosystemPlay: 'Экосистема C++',
  CsharpDatabasePlay: 'C# и базы данных',
  CsharpLanguageRefExplorerPlay: 'Справочник C#',
  DartEcosystemPlay: 'Экосистема Dart',
  DotNetApiExplorerPlay: '.NET API Explorer',
  DotNetEcosystemPlay: 'Экосистема .NET',
  ElixirEcosystemPlay: 'Экосистема Elixir',
  FortranEcosystemPlay: 'Экосистема Fortran',
  FsharpLanguageRefExplorerPlay: 'Справочник F#',
  GoDatabasePlay: 'Go и базы данных',
  GoEcosystemPlay: 'Экосистема Go',
  GroovyDatabasePlay: 'Groovy и базы данных',
  GroovyEcosystemPlay: 'Экосистема Groovy',
  HaskellEcosystemPlay: 'Экосистема Haskell',
  JavaDatabasePlay: 'Java и базы данных',
  JavaScriptRuntimePlay: 'JavaScript Runtime',
  JobDslPlayground: 'Job DSL Playground',
  JsEcosystemPlay: 'Экосистема JavaScript',
  JuliaEcosystemPlay: 'Экосистема Julia',
  KotlinDatabasePlay: 'Kotlin и базы данных',
  KotlinEcosystemPlay: 'Экосистема Kotlin',
  LexicalScopeVisualizer: 'Лексическая область видимости',
  LispEcosystemPlay: 'Экосистема Lisp',
  LuaEcosystemPlay: 'Экосистема Lua',
  NimEcosystemPlay: 'Экосистема Nim',
  NodeDatabasePlay: 'Node.js и базы данных',
  OneCDatabasePlay: '1С и базы данных',
  OneCEcosystemPlay: 'Экосистема 1С',
  OneCPlatformEmulator: 'Эмулятор платформы 1С',
  PascalEcosystemPlay: 'Экосистема Pascal',
  PhpDatabasePlay: 'PHP и базы данных',
  PhpEcosystemPlay: 'Экосистема PHP',
  PowerShellEcosystemPlay: 'Экосистема PowerShell',
  PowerShellShellPlay: 'PowerShell Shell',
  PythonDatabasePlay: 'Python и базы данных',
  PythonEcosystemPlay: 'Экосистема Python',
  REcosystemPlay: 'Экосистема R',
  ReactTreeDemo: 'Дерево React-компонентов',
  RubyDatabasePlay: 'Ruby и базы данных',
  RubyEcosystemPlay: 'Экосистема Ruby',
  RustDatabasePlay: 'Rust и базы данных',
  RustEcosystemPlay: 'Экосистема Rust',
  ScalaEcosystemPlay: 'Экосистема Scala',
  SwiftDatabasePlay: 'Swift и базы данных',
  SwiftEcosystemPlay: 'Экосистема Swift',
  VbArchitecturePlay: 'Архитектура Visual Basic',
  ZigEcosystemPlay: 'Экосистема Zig',
};
...
function inferPlayMeta(manifestKey, docPath) {
  ...
  return {
    playSlug: `languages/${slug}`,
    category: 'languages',
    categoryTitle: 'Энциклопедия · Языки программирования',
    component: slug,
...
function main() {
  ...
  console.log(`Languages components to migrate: ${componentMap.size}`);
  ...
  console.log(`Manifest entries: ${Object.keys(manifest).length} (+${componentMap.size} languages)`);
}
